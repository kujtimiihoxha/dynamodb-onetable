        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (params.throw === false) {
                    ...
                    throw new Error_js_1.OneTableError(`Conditional create failed for "${model}"`, { code: 'ConditionError', trace, err });
                }
                    ...
                    throw new Error_js_1.OneTableError(`OneTable execute failed "${op}" for "${model}. ${err.message}`, { err });
                }
            }
            finally {
                if (result) {
